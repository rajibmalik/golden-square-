...
class TaskTracker
  ...
  def add(task) # task is a string representing instructions 
  end
  
  def list # returns a list of the tasks that have been added
  # fails if there are no tasks added to the list
  end
...
todo_list.list => ["Clean room", "Clean car"]
